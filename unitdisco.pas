      ...
      begin
         ...
         begin}
          //If uos_getstatus(0) = 1 then uos_stop(0);
           ...
           uos_InputSetPositionEnable(0, InputIndex1, 1) ;
           uos_InputSetDSP(0, inputIndex1, 1, true);
           uos_InputSetLevelEnable(0, InputIndex1, 3) ; }

           {InputIndex1 := uos_AddFromFile(0, PChar(LePath), -1, 0, -1);

           {$if defined(cpuarm)} // needs lower latency
           uos_AddIntoDevOut(0, -1, 0.3, uos_InputGetSampleRate(0, InputIndex1), -1, 0, -1, -1);
           {$else}
           uos_AddIntoDevOut(0, -1, -1, uos_InputGetSampleRate(0, InputIndex1), -1, 0, -1, -1);
           {$endif}
