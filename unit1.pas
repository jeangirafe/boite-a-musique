...
begin
    ...
    uos_SetDSPVolumeIn(p, InputIndex1, nNiv, nNiv, true);
...
Procedure StopSon(nLigne: integer);
begin
    //uos_stop(p);
...
begin
     If Form1.GridProg.Cells[6,nLigne]<>'' then
       begin
            ...
            uos_EndProc(nPlayer, @StopSon(nLigne)); /// à la fin du son, il appellera automatiquement la procédure stopson pour décharger le son
            uos_Play(nPlayer);
...
begin
  ...
  If nPlayer<>-1 then
    begin
       ...
       uos_SeekSeconds(nPlayer, InputIndex1 ,nPos);
    end;
                   ...
                   End
                      ...
                      begin
                           ...
                           Case uos_GetStatus(p) of
                             -1:begin
                               //- 1 : pas chargé ----> on ne fait rien (voir lignes plus bas)
